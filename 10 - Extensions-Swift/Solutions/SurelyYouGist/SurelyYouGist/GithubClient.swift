...
let SharedDefaultsSuiteName = "group.com.borkware.SurelyYouGist2"
...
class GithubClient: NSObject {
    ...
    var userID: String? {
        get {
            ...
            //del return defaults.object(forKey: GithubUserNameDefaultsKey) as? String
    ...
    init(urlOpener: GithubURLOpener? = nil) {
